...
SubwayLine.create({name: "Green Line", description: "The Green Line is gregarious and outgoing! Sometimes they don’t get from Point A to B super quickly, but that’s just part of their charm! Loves tourists and the Red Sox.", ideal_owner: "BU/BC Undergrad", image_url: 'green_line.jpg'})
